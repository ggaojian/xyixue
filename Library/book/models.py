...
class Student(models.Model):
    uid = models.CharField('Uid',max_length=50,default='0001')
    number = models.CharField('Number',max_length=50,default='0001')
    name = models.CharField('Name',max_length=50,default='XXX')
    college = models.CharField('College',max_length=100,default='XXX学院')
    speciality = models.CharField('Speciality',max_length=100,default='其他')
    classes = models.CharField("Classes",max_length=50,default='其他')
    year = models.CharField("Year",max_length=20,default='0001')
    def __str__(self):
        return self.uid
